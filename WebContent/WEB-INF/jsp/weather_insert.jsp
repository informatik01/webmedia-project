...
<body>
	<div id="header">
		<img 
		src="<c:url value="/images/header.png" />" alt="Header" />
	</div>
	<div id="mainContent">
	<div id="navMenu">
		<ul>
			...
			<li><a href="#">Manage Weather Information</a>
				<ul>
					<li><a href="new">Insert Weather Data</a></li>
					<li><a href="update">Update Weather Data</a></li>
				</ul>
			</li>
	...
	<h3>
	Weather information insert page.
	</h3>
	</div>
	<p>
